...
namespace YogaStudio.App.Areas.Admin.Controllers
{
    public class AddressesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Street,City,PostalCode")] Address address)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Street,City,PostalCode")] Address address)
        {
            if (ModelState.IsValid)
            {
